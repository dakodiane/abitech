            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Soyez la bienvenue</h3>
                ...
                <small class="text-muted"> Mot de passe oublié ? Réinitialisez votre mot de passe
                  <a href="{{route('password.request')}}" class="text-info text-gradient font-weight-bold"> ici</a>
                </small>
                </div>
              </div>
            </div>
