                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0 mb-4 d-flex align-items-center justify-content-between flex-wrap">
                            ...
                            <div class="buttons  d-flex align-items-center">
                                <form class="d-flex align-items-center" method="get" action="{{ route('mebs') }}">
                            ...
                            @include('dialogs.meb', ['video' => null])
                        </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    @if($videos->count() > 0)
                                        @foreach($videos as $video)
                                            <tr class="px-2">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center flex-wrap ">
                                                        ...
                                                        <form
                                                            action="{{ route('meb.activate',[ 'id' => $video->id ]) }}"
                                                            method="post">
                                                            @csrf
                                                            @if($video->active)
                                                                <button class="btn p-2  d-flex align-items-center me-1 "
                                            ...
                                            @include('dialogs.meb', ['video' => $video])
